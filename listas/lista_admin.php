			...
			<span class="span7">&nbsp; &nbsp; &nbsp;opera&Ccedil;OES REALIZADAS PELO USU&Aacute;RIO</span>
			</form>
			</td>
			</tr>
			</table>
			...
			<td valign="top" class="td3"><span class="span6"><?php echo $resultado['data']; ?></span></td>
			<td valign="top" class="td3"><span class="span6"><?php echo $resultado['hora']; ?></span></td>
			<td valign="top" class="td3"><span class="span6"><?php echo $resultado['ip']; ?></td>
			</tr>
			<tr><?php $cont ++; }?>
			<?php
